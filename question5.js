...
const cameraGear = [
  ...
  function calculateTotalPrice(cameraGear) {
    // Din kod här
    const calculateTotalPrice = (cart) => cart.reduce((total, product) => total + product.price, 0);
  
  

  // Test
  console.log(calculateTotalPrice(cameraGear))
  };